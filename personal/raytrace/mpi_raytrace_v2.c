...
void Build_mpi_types(double *px, double *py, double *pz, double *pr, vec *pvector, MPI_Datatype* input_vec, MPI_Datatype* input_block);
/* */
...
void Build_mpi_types(double *px, double *py, double *pz, double *pr, vec *pvector, MPI_Datatype* input_vec, MPI_Datatype* input_block){
	...
	MPI_Datatype array_of_types_vec = {MPI_DOUBLE, MPI_DOUBLE, MPI_DOUBLE};
	...
	MPI_Datatype array_of_types_block = {input_vec, MPI_DOUBLE};
